...
const projects = [
    ...
    },
 {
    title: 'Sleak Engine',
    logo: DXCraftLogo,
    desc: `A custom game engine built from scratch in C++, designed around a multi-backend graphics architecture supporting DirectX 11, DirectX 12, Vulkan, and OpenGL. Features a component-based entity system, a frame budget manager for performance-aware execution, custom actor pooling, and a platform-independent abstraction layer across all rendering backends. Sleak Engine reflects my professional focus on low-level engine architecture, explicit API design, and performance-critical systems, built with the same principles I apply in production game development.`,
    date: '2024-Present',
    isVisible: true,
    categories: ['Game Development', 'Engine Development'],
    type: 'Game Engine',
    language: [CPPLogo],
    languageNames: ['C++'],
    iconBackground: `#4881bf`,
    ...
    images: [DXCraft1, DXCraft2, DXCraft3],
    preview: DXCraft1
},
  {
